...
-- Database Section
-- ________________ 
drop database if exists gestionale_per_agenzie_rel ;

create database if not exists GESTIONALE_PER_AGENZIE_Rel;
...
create table ATTRAZIONE (
     ...
     TipoAttrazione varchar(50) not null,
...
create table DIPENDENTE (
     ...
     isGuida tinyint not null,
     isTourManager tinyint not null,
     isAltro tinyint not null,
...
create table PERCORSO (
     ...
     Nome varchar(50) not null,
     NumTappe int not null default 3,
     LunghezzaPercorso float not null,
     IDsede char(3) not null,
...
create table SOGGIORNO (
     ...
     PIVA char(11) not null,
     CostoServizio float not null,
     TipoSoggiorno varchar(50) not null,
     IDIndirizzo char(7) not null,
     constraint IDBUSINESSPARTNER_ID primary key (PIVA));
...
-- Constraints Section
-- ___________________ 
alter table DIPENDENTE add constraint FKCFsuperiore
