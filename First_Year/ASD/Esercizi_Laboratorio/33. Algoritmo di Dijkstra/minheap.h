...
/* Inizializza uno heap vuoto in grado di contenere al piu' size
   coppie (chiave, priorità); le chiavi possono essere esclusivamente
   gli interi 0 .. size - 1; ogni chiave può essere presente nello
   heap al più una volta. Inizialmente lo heap è vuoto. */
