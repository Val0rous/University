...
void inserisciElementoTesta(struct cella **trct, int num);
void inserisciElementoCoda(struct cella **trct, int num);
...
int main()
{
    ...
    while (flag)
    {
        ...
        printf("\n 1 - Inserisci nuovo elemento in testa");
        printf("\n 2 - Inserisci nuovo elemento in coda");
        printf("\n 3 - Stampa elenco elementi");
        printf("\n 4 - Cerca elemento");
        printf("\n 5 - Elimina elemento");
        printf("\n 6 - Azzera la lista");
        printf("\n 7 - Esci");
        ...
        switch(opzione)
        {
            case '1': //creazione nuovo elemento, vedi esercizio: creazione_lista_semplice_con_un_elemento.c
                ...
                printf("\n\n Inserisci il valore intero da inserire in testa nella lista: ");
                scanf("%d",&numero);
                fflush(stdin);
                inserisciElementoTesta(&testa, numero);
                printf("\n\n Nuovo elemento creato correttamente!\n ");
                printf("\n\n");
                system("pause");
                break;
            case '2': //creazione nuovo elemento, vedi esercizio: creazione_lista_semplice_con_un_elemento.c
                system("cls");
                printf("\n\n INSERIMENTO IN CODA");
                printf("\n\n Inserisci il valore intero da inserire in coda nella lista: ");
                scanf("%d",&numero);
                fflush(stdin);
                inserisciElementoCoda(&testa, numero);
                printf("\n\n Nuovo elemento creato correttamente!\n ");
                printf("\n\n");
                system("pause");
                break;
            case '3': //stampa degli elementi in lista
                system("cls");
                ...
                system("pause");
                break;
            case '4': //Cerca un elemento nella lista
                system("cls");
...
void inserisciElementoTesta(struct cella **t, int num)
{
...
void inserisciElementoCoda(struct cella **t, int num)
{
    struct cella *nuovoElemento;
    struct cella *temp;
